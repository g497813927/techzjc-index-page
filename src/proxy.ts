...
export function proxy(req: NextRequest) {
  ...
  // Check if this is a static resource access in FC environment without a real host
  // In FC, static resources (/_next/, /photos/, /assets/) can be accessed without a host header
